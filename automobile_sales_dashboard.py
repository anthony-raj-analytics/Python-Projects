...
# ---------------------------------------------------------------
# TASK 2.1: App layout with title
# ---------------------------------------------------------------
app.layout = html.Div([
...
# ---------------------------------------------------------------
# TASK 2.4a: Callback to enable/disable year dropdown
# ---------------------------------------------------------------
@app.callback(
...
# ---------------------------------------------------------------
# TASK 2.4b / 2.5 / 2.6: Callback to update the graphs
# ---------------------------------------------------------------
@app.callback(
...
def update_output_container(selected_statistics, input_year):
    ...
    if selected_statistics == 'Recession Period Statistics':
        ...
        # Plot 1: Automobile sales fluctuation over Recession Period (year wise) - Line chart
        ...
        # Plot 3: Average vehicles sold by vehicle type in the given year - Bar chart
